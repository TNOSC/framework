...
/// <summary>
/// Decorator for validating commands before handling them.
/// </summary>
/// <typeparam name="TCommand">The type of command to handle.</typeparam>
/// <typeparam name="TResult">The type of result returned by the command handler.</typeparam>
public sealed class ValidatingCommandHandlerDecorator<TCommand, TResult> : ICommandHandler<TCommand, TResult>
    ...
    where TResult : class, IResult
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ValidatingCommandHandlerDecorator{TCommand, TResult}"/> class.
    /// </summary>
    /// <param name="validators">The collection of validators for the command.</param>
    /// <param name="handler">The underlying command handler.</param>
    public ValidatingCommandHandlerDecorator(IEnumerable<IValidator<TCommand>> validators, ICommandHandler<TCommand, TResult> handler)
    {
    ...
    /// <summary>
    /// Handles the specified command asynchronously after validation.
    /// </summary>
    ...
    public async Task<TResult> HandleAsync(TCommand command, CancellationToken cancellationToken = default)
    {
        ...
        // Validate the command using the registered validators.
        ...
        // Otherwise, handle the command using the underlying handler.
        return await _handler.HandleAsync(command, cancellationToken);
    }
}